...
void bsubline_2(int x1, int y1, int x2, int y2, ColorP c) {
	int x, y, ddx, ddy, e;
	ddx = abs(x2 - x1) << 1;
	ddy = abs(y2 - y1);
	e = ddy - ddx;
...
void bsubline_3(int x1, int y1, int x2, int y2, ColorP c) {
	int x, y, ddx, ddy, e;
	ddx = abs(x1 - x2) << 1;
	ddy = abs(y2 - y1);
	e = ddy - ddx;
...
void bsubline_4(int x1, int y1, int x2, int y2, ColorP c) {
	int x, y, ddx, ddy, e;
	ddy = abs(y2 - y1) << 1;
	ddx = abs(x1 - x2);
	e = ddx - ddy;
